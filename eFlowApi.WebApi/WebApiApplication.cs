...
namespace eFlowApi.WebApi {
    public partial class eFlowApiWebApiApplication : BlazorApplication {
        public eFlowApiWebApiApplication() {
            InitializeComponent();
        }
        ...
        private void eFlowApiWebApiApplication_DatabaseVersionMismatch(object sender, DatabaseVersionMismatchEventArgs e) {
#if EASYTEST
            e.Updater.Update();
            e.Handled = true;
#else
