...
namespace eFlowMvc.WebApi {
    public partial class eFlowMvcWebApiApplication : BlazorApplication {
        public eFlowMvcWebApiApplication() {
            InitializeComponent();
        }
        ...
        private void eFlowMvcWebApiApplication_DatabaseVersionMismatch(object sender, DatabaseVersionMismatchEventArgs e) {
#if EASYTEST
            e.Updater.Update();
            e.Handled = true;
#else
